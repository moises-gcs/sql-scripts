...
create table orders(
 ...
 payment_date date,
 freigth decimal(14,2) default 0.0
);
...
alter table states add constraint country_fkey foreign key(country) references countries(country_id)
